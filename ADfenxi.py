...
def load_raw_data():
    ...
    # 全局计算上架间隔、生成新品老品标签（整张表统一生成，解决KeyError）
...
# 5 新品拉高整体TACOS（现在df_raw自带产品类型，不会报KeyError）
