...
st.markdown("""
### 三类商品业务定义
1. **老品**：商品开售天数＞60天，成熟稳定款，自然流量充足，分层TACOS通常最低，店铺营收基本盘；
2. **新品**：商品开售天数≤60天且产生成交订单，上架初期自然权重低，依赖广告起量，ACOS普遍高于老品；
3. **新品未出单**：上架≤60天，但广告投放后无任何成交订单，纯消耗广告费，ACOS、TACOS会极端偏高，是低效投放核心来源。

### TACOS上涨分层判断
1. **新品投放占比提升，整体TACOS上行**
...
### 分层优化方向
- 老品：深耕自然流量，提升关键词自然排名，减少广告兜底投放，稳定成本；
- 新品：适度控制竞价，搭配促销活动提升转化，缩短亏损推广周期；
