...
st.markdown("""
### 三类商品业务定义
1. **老品 (开售天数大于60天)**：商品开售天数＞60天，成熟稳定款，自然流量充足，分层TACOS通常最低，店铺营收基本盘；
2. **新品 (开售天数小于等于60)**：商品开售天数≤60天且产生成交订单，上架初期自然权重低，依赖广告起量，ACOS普遍高于老品；
3. **新品未出单**：上架≤60天，但广告投放后无任何成交订单，纯消耗广告费，ACOS、TACOS会极端偏高，是低效投放核心来源。

### TACOS上涨分层判断
1. **新品 (开售天数小于等于60) 投放占比提升，整体TACOS上行**
新品天然转化弱，放量投放会拉高店铺整体广告成本；可搭配优惠券、优化Listing提升CVR降低ACOS。
2. **老品 (开售天数大于60天) TACOS持续走高**
老品自然排名、自然单下滑，只能依靠广告兜底维持销量，销售额萎缩导致TACOS被动抬升。
3. **新品未出单分层花费过高**
该分层无广告营收，每一笔广告花费都会直接拉高整体TACOS，属于重点优化对象，建议缩减预算、优化关键词/主图。

### 分层优化方向
- 老品 (开售天数大于60天)：深耕自然流量，提升关键词自然排名，减少广告兜底投放，稳定成本；
- 新品 (开售天数小于等于60)：适度控制竞价，搭配促销活动提升转化，缩短亏损推广周期；
- 新品未出单：大幅削减广告预算，排查关键词泛流量、主图价格竞争力，长期无转化建议暂停投放。
""")
